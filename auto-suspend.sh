...
\
                        <div class="form-group">\
                            ...
                            <p class="small text-muted no-margin">LXJR OFFC Server akan kadaluarsa (suspend) di akhir hari pada tanggal yang dipilih (kosongkan jika ingin server permanen)<\/p>\
                        <\/div>|
                        }
                    }' \
                    "$file"
